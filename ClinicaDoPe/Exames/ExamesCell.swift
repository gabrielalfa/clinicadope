...
class ExamesCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        hasReadImageView.image = UIImage(named: "check_ok")
...
//        hasReadImageView.anchor(top: nil, left: leftAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 18, paddingBottom: 30, paddingRight: 0, width: 50, height: 50)
    ...
    private func setupContainerView(){
        ...
        addConstraintWithFormat("H:|-130-[V0]|", views: containerView)

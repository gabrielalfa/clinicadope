...
class LoginController: UIViewController {
    ...
    let logoContainerView: UIView = {
        ...
        let logoImageView = UIImageView(image: #imageLiteral(resourceName: "clinica_nome"))
        logoImageView.contentMode = .scaleAspectFit
        
        view.addSubview(logoImageView)
        logoImageView.anchor(top: nil, left: nil, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 200, height: 130)
